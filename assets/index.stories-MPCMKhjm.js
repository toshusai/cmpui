import{j as o}from"./jsx-runtime-DvLKfCe6.js";import{r as s}from"./index-aXz8NaAs.js";import{C as g}from"./alpha-checker-board-CANUayoU.js";import"./createDragHandler-nJMxlNVC.js";function j(e,{onDown:r,onUp:n}){const a=t=>{t.key===e&&(n==null||n(t),window.removeEventListener("keyup",a))};return t=>{t.key===e&&(r==null||r(t.nativeEvent),window.addEventListener("keyup",a))}}function z(){return s.useCallback(e=>{e.currentTarget.focus({preventScroll:!0})},[])}const b={title:"View/CanvasView",component:g,parameters:{layout:"fullscreen"}};function k(e){return o.jsx("div",{style:{width:"100vw",height:512},children:o.jsx(g,{...e,maxScale:50,minScale:.2,content:o.jsx(o.Fragment,{children:o.jsx("div",{style:{width:200,height:100,background:"white"},children:o.jsx("div",{className:"alpha-checker-board",style:{width:200,height:100}})})})})})}const w={render:()=>{const[e,r]=s.useState({x:200,y:100,scale:1}),[n,a]=s.useState([]),c=s.useMemo(()=>[" ","Alt","Shift"].map(i=>j(i,{onDown:u=>{u.preventDefault(),a(l=>l.includes(i)?l:[...l,i])},onUp:()=>{a(u=>u.filter(l=>l!==i))}})),[]),t=i=>{c.map(u=>u(i))},d=s.useMemo(()=>n.includes(" ")?"pan":n.includes("Alt")&&n.includes("Shift")?"zoom-out":n.includes("Alt")?"zoom-in":"default",[n]),D=z();return o.jsx(k,{onKeyDown:t,onChangeView:r,view:e,mode:d,onPointerEnter:D})}},y={render:()=>{const[e,r]=s.useState({x:200,y:100,scale:1});return o.jsx(k,{onChangeView:r,view:e,mode:"pan"})}},m={render:()=>{const[e,r]=s.useState({x:200,y:100,scale:1}),[n,a]=s.useState("zoom-in");return s.useEffect(()=>{const c=d=>{d.key==="Alt"&&(a("zoom-out"),window.addEventListener("keyup",t))},t=d=>{d.key==="Alt"&&a("zoom-in"),window.removeEventListener("keyup",t)};return window.addEventListener("keydown",c),()=>{window.removeEventListener("keydown",c)}},[]),o.jsx(k,{onChangeView:r,view:e,mode:n})}};var h,p,v;w.parameters={...w.parameters,docs:{...(h=w.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => {
